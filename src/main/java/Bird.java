 ...
 * When we create a variable with a class as its datatype, that variable is
 * considered an object.
 * NOTE: We have already seen objects with the String class.
 * Try "ctrl + left-click" on the text "String" to see the source code of the
 * String class.
 * 
 ...
 * their own
 * age, and can generate their own sound. This concept of an object controlling
 * its own data can be
 * referred to as encapsulation.
 *
 * In the app, an individual bird should be able to "Tweet" if ageMonths is less
 * than 3 and "Chirp" if ageMonths is
...
public class Bird {
    /**
     * A variable (in this context, often referred to as a field), which represents
     * the age of the bird.
     */
    public int ageMonths;

    /**
     * A constructor for the bird class: this method allows us to build a new bird
